...
uas = random.choice([
 ...
 'Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.51 Mobile Safari/537.36',
...
def Me():
      os.system("clear")
      print("""
\x1b[1;97m    ___ __  __ ____  _____
...
def tokenz():
	...
	try:
		...
		os.system('clear')
		Me()
                Ivan('\x1b[1;97m[\x1b[1;92m!\x1b[1;97m] Di Sarankan Menggunakan Akun \x1b[1;92mTumbal\x1b[1;90m/\x1b[1;92mBaru')
...
#        user = db['user premium']
    ...
    print("")
    Ivan("\x1b[0;97m[\x1b[0;92m1\x1b[0;97m] Crack Dari Publik Teman \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
    Ivan("\x1b[0;97m[\x1b[0;92m2\x1b[0;97m] Crack Dari Total Followers \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
#    Ivan("\x1b[0;97m[\x1b[0;92m3\x1b[0;97m] Crack Dari Like Postingan \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
    Ivan("\x1b[0;97m[\x1b[0;92m3\x1b[0;97m] Retrieve \x1b[1;91mTarget Data \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
...
#    print("[8] Mulai Crack [File] [Pro]")
    Ivan("\x1b[0;97m[\x1b[0;92m4\x1b[0;97m] Lihat Hasil Crack \x1b[1;97m[\x1b[1;92mPro\x1b[1;97m]")
    Ivan("\x1b[0;97m[\x1b[0;91m0\x1b[0;97m] Keluar \x1b[1;90m( \x1b[1;91mHapus Token \x1b[1;90m)")
    pilih_menumbasic()
...
def pilih_menumbasic():
    ...
    if ask == '':
        ...
        if  status == 'offline' or status =='Offline':
             Ivan("\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] Maaf Server Sedang Offline!")
             exit()
        else:
...
def date_target():
    ...
    time.sleep(3)
    Ivan('\n[•] Name : %s'%(nm))
    Ivan('[•] First name : %s'%(nd))
    Ivan('[•] Middle name : %s'%(nt))
    Ivan('[•] Last name : %s'%(nb))
    Ivan('[•] TTL : %s'%(ut))
    Ivan('[•] Gender : %s'%(gd))
    Ivan('[•] Email : %s'%(em))
    ...
    Ivan('[•] Username : %s'%(us))
    Ivan('[•] Religion : %s'%(rg))
    Ivan('[•] Relationship status : %s'%(rl))
    Ivan('[•] Relationship With : %s'%(rls))
    Ivan('[•] Residence : %s'%(lc))
    Ivan('[•] Place  Origin : %s'%(ht))
    Ivan('[•] About : %s'%(ab))
    Ivan('[•] Local : %s'%(lo))
    raw_input('\n[?] Enter Untuk Kembali')
    menu()
